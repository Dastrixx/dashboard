...
export const categories = [
  { name: "Домашний текстиль", share: 48, color: "#0b7a55" },
  { name: "Посуда", share: 31, color: "#27a879" },
  { name: "Одежда", share: 13, color: "#d49a3a" },
  { name: "Бытовая химия", share: 8, color: "#aab8b1" },
];

const productTemplates = [
  ["КПБ «Сатин Люкс» 1.5-сп", "Домашний текстиль"],
  ["КПБ «Ранфорс Премиум» 2-сп", "Домашний текстиль"],
  ["КПБ детское «Мишки» 1.5-сп", "Домашний текстиль"],
  ["Простыня на резинке 160×200", "Домашний текстиль"],
  ["Пододеяльник «Страйп» 2-сп", "Домашний текстиль"],
  ["Наволочка «Сатин» 70×70 (2 шт)", "Домашний текстиль"],
  ["Полотенце махровое 50×90", "Домашний текстиль"],
  ["Полотенце махровое 70×140", "Домашний текстиль"],
  ["Набор полотенец «Бамбук» 3 пр.", "Домашний текстиль"],
  ["Полотенце банное «Велюр» 100×150", "Домашний текстиль"],
  ["Тюль-сетка белая 300×270", "Домашний текстиль"],
  ["Штора блэкаут «Гранд» 200×270", "Домашний текстиль"],
  ["Комплект штор «Софт» 2 полотна", "Домашний текстиль"],
  ["Ламбрекен «Классик»", "Домашний текстиль"],
  ["Плед флисовый 150×200", "Домашний текстиль"],
  ["Покрывало стёганое 220×240", "Домашний текстиль"],
  ["Плед «Мех» 130×160", "Домашний текстиль"],
  ["Скатерть «Прованс» 150×220", "Домашний текстиль"],
  ["Набор кухонных полотенец 5 шт", "Домашний текстиль"],
  ["Фартук + прихватка «Уют»", "Домашний текстиль"],
  ["Бязь набивная (за метр)", "Одежда"],
  ["Сатин однотонный (за метр)", "Одежда"],
  ["Флис (за метр)", "Одежда"],
  ["Лён костюмный (за метр)", "Одежда"],
] as const;
